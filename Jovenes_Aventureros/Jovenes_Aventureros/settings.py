"""
Django settings for Jovenes_Aventureros project.
...
ROOT_URLCONF = 'Jovenes_Aventureros.urls'
...
WSGI_APPLICATION = 'Jovenes_Aventureros.wsgi.application'
...
# WhiteNoise configuration for static files - versión que no falla con Font Awesome
